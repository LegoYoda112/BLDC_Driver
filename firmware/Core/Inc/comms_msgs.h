...
#define PARAM_ENCODER_OFFSET 161
// DEF [OFFSET]

#define PARAM_ANTI_COGGING_TABLE 162
// DEF [POS, VALUE, VALUE]

#define PARAM_ANTI_COGGING 170

#define PARAM_CURRENT_GAIN 180
// DEF [VALUE VALUE]
#define PARAM_CURRENT_LIMIT 181
// DEF [VALUE VALUE]
#define PARAM_POSITION_GAIN 185
// DEF [VALUE VALUE]
