// Based on https://pcbartists.com/firmware/stm32-firmware/generating-32-bit-stm32-unique-id/
#include "uid_hash.h"

using namespace uid_hash;
...
uint32_t uid_hash::get_32bit_uid() {
    return device_uid;
}